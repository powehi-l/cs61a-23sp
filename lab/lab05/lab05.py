...
def closer_city(lat, lon, city_a, city_b):
    ...
    if distance(city_a, make_city('city', lat, lon)) < distance(city_b, make_city('city', lat, lon)):
...
def count_palindromes(L):
    ...
    2
    """
    return len([word[::-1] for word in L if word[::-1].lower() == word.lower()])
